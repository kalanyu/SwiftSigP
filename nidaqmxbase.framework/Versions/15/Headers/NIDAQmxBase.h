...
#define  DAQmxBase_kProcessorX64     0
#define  DAQmxBase_kApple            0

#if    ((defined(__GNUG__) || defined(__GNUC__)) && defined(__x86_64__) && defined(__APPLE__))
#undef   DAQmxBase_kProcessorX64
#define  DAQmxBase_kProcessorX64    1

#undef   DAQmxBase_kApple
#define  DAQmxBase_kApple           1
#endif

#if    ((defined(__GNUG__) || defined(__GNUC__)) && defined(__x86_64__) && defined(__linux__))
#undef  DAQmxBase_kProcessorX64
#define DAQmxBase_kProcessorX64     1

#undef  DAQmxBase_kLinux
#define DAQmxBase_kLinux            1
#endif
...
#endif
NIStaticAssert(sizeof(int8) == 1, "Error: This platform is unsupported because int8 is not 1 bytes.");

#ifndef _NI_uInt8_DEFINED_
#define _NI_uInt8_DEFINED_
   typedef unsigned char      uInt8;
#endif
NIStaticAssert(sizeof(uInt8) == 1, "Error: This platform is unsupported because uInt8 is not 1 bytes.");

#ifndef _NI_int16_DEFINED_
#define _NI_int16_DEFINED_
   typedef signed short       int16;
#endif
NIStaticAssert(sizeof(int16) == 2, "Error: This platform is unsupported because uInt16 is not 2 bytes.");

#ifndef _NI_uInt16_DEFINED_
#define _NI_uInt16_DEFINED_
   typedef unsigned short     uInt16;
#endif
NIStaticAssert(sizeof(uInt16) == 2, "Error: This platform is unsupported because uInt16 is not 2 bytes.");

#ifndef _NI_int32_DEFINED_
#define _NI_int32_DEFINED_
   #if ((DAQmxBase_kApple || DAQmxBase_kLinux) && DAQmxBase_kProcessorX64)
...
#endif
NIStaticAssert(sizeof(float32) == 4, "Error: This platform is unsupported because float32 is not 4 bytes.");

#ifndef _NI_float64_DEFINED_
#define _NI_float64_DEFINED_
   typedef double             float64;
#endif
NIStaticAssert(sizeof(float64) == 8, "Error: This platform is unsupported because float64 is not 8 bytes.");
...
#define _NI_int64_DEFINED_
   ...
   #else
      #if (DAQmxBase_kApple && DAQmxBase_kProcessorX64)
   ...
   #endif
#endif
NIStaticAssert(sizeof(int64) == 8, "Error: This platform is unsupported because int64 is not 8 bytes.");
...
#define _NI_uInt64_DEFINED_
   ...
   #endif
#endif
NIStaticAssert(sizeof(uInt64) == 8, "Error: This platform is unsupported because uInt64 is not 8 bytes.");
