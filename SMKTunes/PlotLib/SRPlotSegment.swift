...
class SRPlotSegment : NSObject, CALayerDelegate {
    ...
    fileprivate var axeSystem : SRPlotAxe?
    fileprivate var index: Int = 0;
    fileprivate var dataStorage = [[Double]]()
    ...
    func draw(_ layer: CALayer, in ctx: CGContext) {
        ...
        for c in 0 ..< dataStorage.count
        {
            ...
            ctx.setStrokeColor(NSColor.prismColor[c].cgColor);
    ...
    fileprivate func minMaxNormalization(_ input: Double, min: Int, max: Int) -> Double {
